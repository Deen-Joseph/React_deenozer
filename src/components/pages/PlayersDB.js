  ...
  return (
    ...
    <ul className="flex-outer">
      ...
      <li>
        ...
        <input type="text" id="first-name" {...register("first-name")} placeholder="Enter your first name here"></input>
      </li>
      <li>
        <label htmlFor="last-name">Last Name</label>
        <input type="text" id="last-name" {...register("last-name", { required: true })} placeholder="Enter your last name here"></input>
        {errors.exampleRequired && <span>This field is required</span>}
      </li>
      <li>
        <label htmlFor="nation">Nationality</label>
        <input type="text" id="nation" placeholder="Enter Nationality here" {...register("nation")}></input>
      </li>
      <li>
        <label htmlFor="club">Club</label>        
        <select id="club" placeholder="Select your club" {...register("club")}>
      ...
      <li>
        ...
        <input type="date" id="dob" placeholder="Enter Date of Birth here" {...register("dob")}></input>
      </li>
      <li>
        <label htmlFor="about">About</label>
        <textarea rows="6" id="about" placeholder="Enter Enter about Player" {...register("about")}></textarea>
      </li>

      <li>
        <label htmlFor="position">Position</label>        
        <select id="position" placeholder="Select Position" {...register("Position")}>
            ...
            <option value="Centre Attacking-Midfield">Centre Attacking-Midfield</option>
